package com.kaamiljasani.jprompter.terminal;

import java.io.IOException;
import java.util.ArrayList;
import java.util.function.Function;

import com.kaamiljasani.jprompter.Prompter;
...
public class TerminalPrompter implements Prompter {
    ...
    private TerminalSpinner spinner;

    public static TerminalPrompter getInstance() throws IOException {
        if (instance == null) {
            instance = new TerminalPrompter();
        }
        return instance;
    }
    ...
    public class TerminalSpinner extends Thread implements Prompter.Spinner {
        ...
        private TerminalSpinner(String message, int interval, String... frames){
